#!/bin/bash
# HMMT 2025 Inference - DeepSeek-R1-Distill-Llama-70B (512 traces)
...
echo "========================================="
echo "DeepSeek-R1-Distill-Llama-70B - HMMT 2025 (512 traces)"
echo "========================================="
...
python scripts/run_vllm_batch.py \
    ...
    --rid deepseek_r1_llama70b_hmmt2025_512 \

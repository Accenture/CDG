#!/bin/bash
# Run all 4 datasets with DeepSeek-R1-0528-Qwen3-8B (512 traces)
# Priority order: aime2025 -> bruno2025 -> hmmt2025 -> aime2024
#
# Usage:
#   screen -S deepseek8b_inference
#   cd /path/to/sampling_credit
#   ./scripts/deepseek8b/run_all.sh
...
echo "========================================================"
echo "DeepSeek-R1-8B Inference - All Datasets (512 traces)"
echo "========================================================"
echo "Settings (per DeepConf paper Table 11):"
echo "  Model: ${DEEPSEEK8B_MODEL}"
